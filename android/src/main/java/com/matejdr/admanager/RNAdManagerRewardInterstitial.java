...
public class RNAdManagerRewardInterstitial extends ReactContextBaseJavaModule {

    public static final String REACT_CLASS = "CTKRewardedInterstitial";

    public static final String EVENT_AD_LOADED = "rewardinterstitialAdLoaded";
    public static final String EVENT_AD_FAILED_TO_LOAD = "rewardinterstitialAdFailedToLoad";
    public static final String EVENT_AD_OPENED = "rewardinterstitialAdOpened";
    public static final String EVENT_AD_CLOSED = "rewardinterstitialAdClosed";
    ...
    public RNAdManagerRewardInterstitial(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void setTargeting(ReadableMap targetingObjects) {
        ...
        if (targetings.hasNextKey()) {
            for (ReadableMapKeySetIterator it = targetingObjects.keySetIterator(); it.hasNextKey();) {
...
//         }
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                if (mRewardedInterstitialAd != null) {
                    ...
                    RewardedInterstitialAd.load(reactContext, adUnitId, adRequest,
                            new RewardedInterstitialAdLoadCallback() {
                                @Override
                                public void onAdLoaded(RewardedInterstitialAd interstitialAd) {
                                    WritableMap event = Arguments.createMap();
                                    event.putString("type", "rewardinterstitial");
                                    ...
                                    mRewardedInterstitialAd = interstitialAd;
                                }
    ...
    public void isReady(final Callback callback) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                callback.invoke(mRewardedInterstitialAd);
            }
        });
    }
}
